...
#ifndef H_lightspeed_SCRIPT
#define H_lightspeed_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a ClightspeedAddress
 */
...
public:
    ...
    // Pre-version-0.6, lightspeed always counted CHECKMULTISIGs
