...
#ifndef _lightspeedRPC_H_
#define _lightspeedRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // lightspeed is not connected
...
/**
 * lightspeed RPC command dispatcher.
 */
class CRPCTable
{
private:
