...
#ifndef lightspeed_MAIN_H
#define lightspeed_MAIN_H
...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 3 * CENT;	// 3% annual interest
...
static const uint256 hashGenesisBlock("0x000004b97d88eb0ee92c1c9c5b6d7b1a93db3f0fedb808892299548ba55edb02");
...
public:
    ...
    {
        // lightspeed: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of lightspeeds spent by this transaction.
    ...
    /** Amount of lightspeeds coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // lightspeed: get transaction coin age
...
public:
    ...
    // lightspeed: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // lightspeed: two types of block: proof-of-work or proof-of-stake
    ...
    // lightspeed: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // lightspeed: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // lightspeed: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // lightspeed: block index flags
    enum  
    {
